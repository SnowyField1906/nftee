	...
	if (active) {
		return (
			<div className="w-full h-[2.75rem] grid relative self-center
				...
				<p className="fixed left-[52px] float-right self-center font-semibold text-lg text-white">Create</p>
			</div>
		)
	}
	return (
		<div className="w-[2.75rem] hover:w-full h-[2.75rem] grid relative self-center
			...
			<p className="fixed left-12 float-right self-center font-semibold text-lg ">Create</p>
		</div >
	)
}
