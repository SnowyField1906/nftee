...
function About() {
    return (
        <div className='grid grid-cols-3 h-screen overflow-hidden select-none w-full px-[3%]'>
            ...
            <div className='relative grid justify-between self-center justify-self-center w-11/12 px-[2%] h-5/6 backdrop-blur-xl bg-white/50 dark:bg-black/50 border-1 rounded-2xl translate-y-10 z-10 main-overflow'>
                ...
                <div className='absolute top-[10%]  grid place-content-start'>
                    <div className='text-xl w-[90%] justify-self-center'>
                        <p className='para-1 mt-0'>
                            237 hours of coding, but I did not finish it in time.
                        </p>
                        <p className='para-2'>
                        ...
                        <p className='para-2'>
                            First thank to Triet Dinh teacher for teaching me with great enthusiasm. Second thank to DEVERA Academy for giving me priceless memories and moments.
                        </p>
                        <p className='para-2'>
                            My sadness keeps growing when I have to leave this place, I will always remember these help and the great time with you.
                        </p>
                        <p className='para-1'>
                            Kindly thanks for Lecle Vietnam and ICON Foundation's sponsorship.
                        </p>
                        <p className='para-2'>
                            I incredibly feel thankful and I hope my expression of this sincerest gratitude can reach to you all. Without the sponsorship, I will never be able to have this amazing knowledge.
                        </p>
                        <p className='para-2 mb-5'>
                            After finishing this course, Whether I can pass or not, I will still follow and work on ICON.
                        </p>
                    </div>
                </div>
            </div>
