...
function LoadWallet({ setTag, account, setAccount }) {
    ...
    return (
        <div className='flex-col h-full transform duration-300 ease-in-out w-[60%] select-none'>
            ...
            <div className='h-[25%] w-[60%] ml-[20%] text-black dark:text-white grid mt-10 border-2 rounded-xl items-center'>
                ...
                <div className='grid w-[90%] justify-self-center'>
                    <div className="flex justify-evenly">
                        <input className='self-center w-[70%] h-12 my-5 rounded-xl invalid:default:border-red-500 default:border-gray-900 default:dark:border-gray-100 bg-gray-200 dark:bg-gray-800 text-black dark:text-white'
            ...
            <div className='h-[25%] w-[60%] ml-[20%] text-black dark:text-white grid mt-10 border-2 rounded-xl items-center'>
                ...
                <div className='grid w-[90%] justify-self-center'>
                    <div className="flex justify-between">
                        ...
                        <input className='self-center w-[47%] h-12 my-5 rounded-xl invalid:default:border-red-500 default:border-gray-900 default:dark:border-gray-100 bg-gray-200 dark:bg-gray-800 text-black dark:text-white'
            ...
            <div className='w-full h-[40%] overflow-hidden grid grid-cols-1 grid-rows-2 mt-10 items-center'>
                <div className="grid w-4/5 justify-self-center self-center">
                    <div className='flex h-14 rounded-xl bg-gray-200 dark:bg-gray-800'>
                        <div className="w-1/5 h-14 flex place-items-center rounded-tl-xl border-2 bg-gray-100 dark:bg-gray-900 border-gray-900 dark:border-gray-100">
                            <p className='pl-4 font-semibold text-black dark:text-white'>Address</p>
                        </div>
                        <div className="flex justify-between place-items-center w-4/5 h-14 rounded-tr-xl border-y-2 border-r-2 hover:cursor-pointer bg-gray-200 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 border-gray-900 dark:border-gray-100">
                            <p className="pl-4  text-black dark:text-white">
                                {loadAccount.address ?? "no data"}
                            </p>
                            <svg className="w-7 h-7 mr-4 fill-slate-400 dark:fill-slate-600 hover:fill-slate-600 dark:hover:fill-slate-400"
                    ...
                    <div className='flex rounded-xl'>
                        <div className="flex justify-between place-items-center h-14 w-1/5 rounded-bl-xl border-x-2 border-b-2 bg-gray-100 dark:bg-gray-900 border-gray-900 dark:border-gray-100">
                        ...
                        <div className="flex w-4/5 h-14 justify-between place-items-center rounded-br-xl border-b-2 border-r-2 hover:cursor-pointer bg-gray-200 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 border-gray-900 dark:border-gray-100">
                            <p className="pl-4 text-black dark:text-white">
