...
function CreateWallet({ wallet, setTag, account, setAccount }) {
    ...
    return (
        <div className='h-full transform duration-300 ease-in-out w-[60%] select-none overflow-x-hidden'>
            ...
            <div className='w-full h-[80%] overflow-hidden grid grid-cols-1 grid-rows-2'>
                <div className="grid w-4/5 justify-self-center self-center">
                    ...
                    <div className='flex rounded-xl'>
                        ...
                        <div className="flex w-4/5 h-14 justify-between place-items-center rounded-br-xl border-b-2 border-r-2 hover:cursor-pointer bg-gray-200 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 border-gray-900 dark:border-gray-100">
                            <p className="pl-4 text-black dark:text-white">
                                {view ? wallet.getPrivateKey() : "*".repeat(64)}
                            </p>
                            <svg className="w-7 h-7 mr-4 fill-slate-400 dark:fill-slate-600 hover:fill-slate-600 dark:hover:fill-slate-400"
                ...
                <div className='grid w-4/5 h-[40%] justify-self-center'>
                    ...
                    <div className="flex justify-evenly">
                        <input className='w-[45%] h-12 my-5 rounded-xl invalid:default:border-red-500 default:border-gray-900 default:dark:border-gray-100 bg-gray-200 dark:bg-gray-800 text-black dark:text-white'
