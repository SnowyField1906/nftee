				...
				{account.login &&
					<>
						...
						<div className="w-[6rem] h-[2.75rem] grid place-content-center">
							<svg onClick={() => setAccount({ ...account, login: false })} className="w-8 h-8 cursor-pointer fill-slate-700 dark:fill-slate-300 hover:fill-violet-700 dark:hover:fill-violet-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
